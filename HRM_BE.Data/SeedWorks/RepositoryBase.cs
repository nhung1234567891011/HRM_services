...
{
    public class RepositoryBase<T, Key> : Core.ISeedWorks.IRepositoryBase<T, Key> where T : EntityBase<Key>

    {
        private readonly DbSet<T> _dbSet;
        protected readonly HrmContext _dbContext;
        protected readonly IHttpContextAccessor _httpContextAccessor;


        public RepositoryBase(HrmContext context, IHttpContextAccessor httpContextAccessor)
        {
