...
namespace HRM_BE.Api.Services
{
    public class AuthService:IAuthService
    {
        ...
        public AuthService(HrmContext dbContext, IConfiguration config, UserService userService, UserManager<User> userManager, IMailService mailService, IMapper mapper, SignInManager<User> signInManager, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<string> CreateToken(User user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(ClaimTypeConstant.OrganizationId,user.Employee.OrganizationId.ToString()),
                new Claim(ClaimTypeConstant.EmployeeId, user.Employee.Id.ToString())
        ...
        public async Task<LoginResult> RefreshToken(string refreshToken)
        {
            ...
            var user = await _userManager.Users.Include(u=>u.Employee).FirstOrDefaultAsync(u=>u.UserName==username);
