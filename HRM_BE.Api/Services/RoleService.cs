...
namespace HRM_BE.Api.Services
{
    public class RoleService:IRoleService
    {
        ...
        public RoleService(HrmContext dbContext, IMapper mapper, IUserService userService, PermissionService permissionService, RoleManager<Role> roleManager, UserManager<User> userManager)
        {
